...
// #pragma message(__FILE__ "(" CPL_STRINGIZE(__LINE__) "): CPL: Unexpected
// compiler, expected C++20 compiler") #error Error in C++ CPL usage;
// Unsupported compiler. #endif  // !(__cplusplus >= 202002L)
